...
public class ChuyenTienRaChu {
	...
	static HashMap<String, String> hm_tien = new HashMap<String, String>() {
    ...
    static HashMap<String, String> hm_hanh = new HashMap<String, String>() {
...
//    }
    ...
    public static String ChuyenSangChu(String x) {
        ...
        kq = kq.substring(0, 1).toUpperCase() + kq.substring(1, kq.length() - 1);
        return kq;
    }

    public static String currencyFormat(String curr)  throws ParseException {
        try {
